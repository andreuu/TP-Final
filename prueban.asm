...
INVERTIR
	MOVF	N1_CENTENA,AUX
	MOVF	N2_CENTENA,N1_CENTENA
	MOVF	AUX,N2_CENTENA
	
	MOVF	N1_DECENA,AUX
	MOVF	N2_DECENA,N1_DECENA
	MOVF	AUX,N2_DECENA

	MOVF	N1_UNIDAD,AUX
	MOVF	N2_UNIDAD,N1_UNIDAD
	MOVF	AUX,N2_UNIDAD
	GOTO	RESTA
...
OP_CARRY_UNIDAD
	...
	BSF		STATUS,C
	DECF	N1_DECENA;SE LE PIDE 1 A LA DECENA
	BTFSC	STATUS,C
	GOTO 	SEGUIR
...
OP_CARRY_DECENA
	...
	BSF		STATUS,C
	DECF	N1_CENTENA;SE LE PIDE 1 A LA CENTENARIA CONCHA DE TUMADRE
	BTFSC	STATUS,C
	GOTO 	SEGUIR1
